<!--#include virtual="/content/inc/html5_top.inc"-->
	<div class="top-content">
	    <div class="inner-bg">
	    	<div class="container">
	    		<div class="row">
	    			<div class="jumbotron form-box form-bottom text">
              ...
              <a class="btn btn-link-2 qna_btn pull-right " id="btn_write" href="/qna.asp"><strong> 글쓰기	</strong></a>
	    		...
	    		<div class="row">
	    			<div class="col-sm-8 col-sm-offset-2 form-box">
		    			<ul class="list-group">
		    				<a href = "#" class="list-group-item qna_list_item row">
								<p class = "list-group-item-heading col-sm-7">
									글제목
								</p>
								<p class = "list-group-item-text col-sm-2">
									작성자
								</p>
								<p class = "list-group-item-text col-sm-3">
									작성일자
								</p>
							</a>
							<a href = "#" class="list-group-item qna_list_item row">
