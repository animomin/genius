    ...
    <div class="row">
        <div class="col-lg-12">
          ...
          <div class="section text game-container">
            ...
            <p align="middle" id="ladder-container">
              <iframe
                frameborder="no"
                src="http://named.com/game/ladder/"
                width="830"
                height="613"
                scrolling="no"
                align="middle"
            ...
            <div class="panel panel-default game-group">
              <div class="panel-heading font-bold game-header">
                <span class="glyphicon ic-cate-real cate-12"></span> <!-- cate-8, flag-1 은 코딩으로 빼자 -->
                <label class="label label-inverse">달팽이레이싱 000회 00-00 00:00</label>
              </div>
              <div class="panel-body game-row">
                <div class="btn-group btn-group-justified">
                 <a href="#" class="btn btn-default">
                   <div class="col-xs-12 col-md-6 text-left game-name"><label class="label label-danger">네</label>000회차</div>
                   <div class="col-xs-12 col-md-6 text-right game-score">00.00</div>
                 </a>
                 <a href="#" class="btn btn-default">
                   <div class="col-xs-12 col-md-6 text-left game-name"><label class="label label-success">임</label>000회차</div>
                   <div class="col-xs-12 col-md-6 text-right game-score">00.00</div>
                 </a>
                 <a href="#" class="btn btn-default">
                   <div class="col-xs-12 col-md-6 text-left game-name"><label class="label label-primary">드</label>000회차</div>
                   <div class="col-xs-12 col-md-6 text-right game-score">00.00</div>
                 </a>
                </div>
              </div>
