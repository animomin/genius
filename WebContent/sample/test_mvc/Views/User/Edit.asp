...
<table>
    ...
    <tr>
		...
		<!--Html.TextArea("ProjectID", Model.ProjectID, 60, 15)-->
		<!--Html.TextBox("ProjectID", Model.ProjectID)-->
		<!--Html.CheckBox("ProjectID", Model.ProjectID)-->
		<!--Html.DropDownList("ProjectID", Model.ProjectID, new ProjectIDHelper.SelectAll.Items, "Id", "ProjectIDName")-->
		<!--int-->
	</td>
    </tr>
