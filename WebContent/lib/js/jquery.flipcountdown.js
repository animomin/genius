					...
					if( typeof value!=='undefined' ){
						switch( value.constructor ){
							case Date:
								...
								var curday = value.getFullYear() + "년 ";
								curday += (value.getMonth() + 1) + "월 ";
								curday += value.getDate() + "일 ";
								curday += week[value.getDay()] + "요일 ";
